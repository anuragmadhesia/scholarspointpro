...
if ($_SESSION['type']=='admin') {
    ...
    {
    $adminid=$_GET['fid'];
    $msg=mysqli_query($con,"delete from tbl_faculty where fid='$adminid'");
    if($msg)
    {
    $alrt=1;
    }
...
<center><h1 style="color:greenyellow;padding-top:11px;">Faculty details</h1></center>
        <center style="overflow-x:auto;">
            <table class="table" id="example">
                ...
                <?php $ret=mysqli_query($con,"select * from tbl_faculty");
							  ...
							  {?>
                        <tr>
                            <td class="pd"><?php echo $row['fid'];?></td>
                            <td><?php echo $row['name'];?></td>
                            <td><?php echo $row['qualification'];?></td>
                            <td><?php echo $row['subject'];?></td>
                            <td><?php echo $row['experience'];?></td>
                            <td><?php echo $row['contact'];?></td>
                            <td><img src="images/faculty/<?php echo $row['ipic'];?>" style="height:70px;width:70px;border:3px solid black;" /></td>
                            <td class="pd"><a href="Faculty_edit.php?fid=<?php echo $row['fid'];?>"><center><span class="fa fa-edit btn btn-primary"></span></center></a></td>
                            <td class="pd"><a href="Faculty.php?fid=<?php echo $row['fid'];?>"><center><button class="btn btn-danger btn-xs" onClick="return confirm('Do you really want to delete');"><i class="fa fa-trash-o "></i></button></center></a></td>
                        </tr>
                        <?php }?>
    ...
    <a href="Faculty_add.php" style="font-size:19px;font-weight:500;">ADD FACULTY</a>
    </div>

...
if(isset($_POST['edit']))
{
    ...
    $sql=mysqli_query($con,"update tbl_students set name='$name' ,dob='$dob',mobile='$mob',class='$clas',board='$bord',subject='$sub',address='$adrs' where rid='$rid'");
if($sql)
{
$alrt=3;
}
...
<?php
    ...
    elseif($alrt==3){
        echo "<script>alert('Students details updated...');</script>";
    }
    $alrt=0;
    ;
include('includes/header.php');
$ret=mysqli_query($con,"select * from tbl_students where rid='".$_GET['up']."'");
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="col-md-5 mb-3">
                Class<input type="text" class="form-control" value="<?php echo $row['class'];?>" name="txtclass" onkeypress="return checkValid(event)" />
            </div>
            <div class="col-md-4 mb-3">
                Board<input type="text" class="form-control" value="<?php echo $row['board'];?>" name="txtboard" onkeypress="return checkValid(event)" />
            </div>
            <div class="col-md-3 mb-3">
                Subject<input type="text" class="form-control" value="<?php echo $row['subject'];?>" name="txtsubject" onkeypress="return checkValid(event)"/>
            </div>
        </div>
        <div class="form-row">
